...
vim.api.nvim_set_keymap('n', '<Tab>', [[:lua if vim.bo.modifiable and not vim.bo.readonly and vim.bo.modified then vim.cmd('write') end vim.cmd('bnext')<CR>]], { noremap = true, silent = true })
